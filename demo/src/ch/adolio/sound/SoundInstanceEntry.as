	...
	public class SoundInstanceEntry extends Sprite implements IAnimatable
	{
		...
		private function onPauseResumeButtonTriggered():void
		{
			if (_soundInstance)
			{
				...
				{
					// Play
					_soundInstance.play(_soundInstance.volume, _positionSlider.value * _soundInstance.totalLength, _soundInstance.loopsRemaining);
				}
			}
		}
		...
		private function updateLoopingStatus():void
		{
			...
			if (_soundInstance.loops == -1)
				...
				_loopsLabel.text = (_soundInstance.loops - _soundInstance.loopsRemaining) + "/" + _soundInstance.loops;
		}
	}
}